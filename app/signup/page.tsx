        ...
        <div className="w-full max-w-md space-y-8 glass-card rounded-2xl p-8 sm:p-10 border border-border/50">
          ...
          <form className="mt-8 space-y-6" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              <button
                type="submit"
                className="w-full flex justify-center py-3 px-4 rounded-xl text-sm font-bold text-white bg-primary hover:bg-primary/90 transition-smooth shadow-lg shadow-primary/20 disabled:opacity-50"
              >
                Sign up
              </button>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link href="/login" className="font-semibold text-primary hover:text-primary/80 transition-smooth">
              Sign in
            </Link>
          </p>
        </div>
